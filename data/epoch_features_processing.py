...
def spectral_power(signal, signal_properties, frequency_interval=None, stft_duration=5,
    ...
    # print("freq after stft", freq)  # freq.shape after stft (129,)
    # print("signal_stft.shape after stft", signal_stft.shape)  # signal_stft.shape after stft (1, 16, 129, 31)
    return signal_stft
